      ...
      <div className="flex flex-wrap justify-center gap-5">
        {[
          ...
          <button
            ...
            className="floating-buttons-style px-6 py-2.5 rounded-xl font-medium text-green-100 transition-transform duration-300 hover:scale-105 focus:outline-none active:scale-95"
            type="button"
          >
            {btn.label}
          </button>
