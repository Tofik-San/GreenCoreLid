                  ...
                  <div className="bg-black/40 transition-all duration-300 rounded-3xl shadow-[0_0_50px_rgba(83,255,148,0.25)] p-16 w-[420px] min-h-[450px] flex flex-col items-center justify-between hover:shadow-[0_0_70px_rgba(83,255,148,0.45)]">
                    ...
                    <div className="text-green-200 mb-10 text-lg leading-relaxed space-y-5 text-center max-w-[340px]">
                      {plan.name.toLowerCase() === "free" && (
                        <>
                          <p>
                            Ознакомительный <strong>бесплатный</strong> доступ
                            для тестирования API и структуры данных.
                          </p>
                          <p>
                            Подходит для первых запросов и проверки логики
                            фильтров.
                          </p>
                          <p>
                      ...
                      {plan.name.toLowerCase() === "premium" && (
                        <>
                          <p>
                            Рабочий тариф для дизайнеров, проектировщиков и
                            студий.
                          </p>
                          <p>
                            Оптимален для подбора растений под реальные задачи и
                            сценарии.
                          </p>
                          <p>
                      ...
                      {plan.name.toLowerCase() === "supreme" && (
                        <>
                          <p>
                            Расширенный доступ для активной и системной работы с
                            базой.
                          </p>
                          <p>
                            Подходит для сервисов, интеграций и пакетных
                            выборок.
                          </p>
                          <p>
